...
export type TzZone = { iana: string; name: string; sub?: string };
export type TzSubGroup = { label: string; zones: TzZone[] };
export type TzGroup = { label: string; subGroups: TzSubGroup[] };
