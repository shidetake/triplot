...
describe("pickReferenceDate", () => {
  ...
  it("年をまたいで測る（対象が2月なら前年3月より前年1月が近い…ではなく)", () => {
    // 2027-02-27 に対し 2026-03-22 は 23日差、2027-01-28 は 30日差。
    // 「新しい方」ではなく「時期が近い方」を選ぶ。
    expect(pickReferenceDate("2027-02-27", ["2026-03-22", "2027-01-28"])).toBe(
      "2026-03-22",
    );
  });
});
