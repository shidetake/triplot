...
//   tScale  T を 5% 縮めて余白を稼ぐ（上148/下103 → 上167/下122）。下にずらす
//           案は採らない — 上が詰まって見える原因はスクワークルの角と横棒の端の
//           干渉で、上下のバランスではない。ずらすと既に狭い下がさらに狭くなる。
//   meshN   地のメッシュ。4×4 で地の三角形の平均が T の内側の 0.80 倍になる
//           （6×6 だと 0.53 倍で、地のほうが目に見えて細かかった）。
const FINAL = { tilts: [12, 12, 12], greyTop: 0.93, greySpan: 0.09, tScale: 0.95, meshN: 4 };
